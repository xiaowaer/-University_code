...
<div class="x-body">
    <form class="layui-form" id="mypics"   accept-charset="UTF-8" >
        ...
        <div class="layui-form-item">
           ...
           <input type="text" id="v_picsheadurl" name="v_picsheadurl"
                       autocomplete="off" value="" class="layui-input">
            ...
            <div class="layui-input-block">
                ...
                <div class="layui-upload-list">
                 ...
                 <a id="uploadVideobtn" class="layui-btn">上传</a>  
 				 <a  class="layui-btn"  id="createpics" onclick="createpics(this)" href="javascript:(0);" >创建</a> 
      </div>
                </div>     
    </form> 
</div>
...
function createpics(obj){
	 	var picsname=$("#v_picsname").attr("value");
	    var picsheadurl=$("#v_picsheadurl").attr("value");
	    var picskeyword=$("#v_picskeyword").attr("value");
	    var cid = $("#fieldSelect").attr("value");
	    if(picsname== ""){
	    	layer.msg('图册标题不能为空',{icon:2,time:2000});
	    	return false;
	    }
	    if(picsheadurl== ""){
	    	layer.msg('图册首图不能为空',{icon:2,time:2000});
	    	return false;
	    }
	    if(picskeyword== ""){
	    	layer.msg('图册关键字不能为空',{icon:2,time:2000});
	    	return false;
	    }
	    console.log(picsname);
	    console.log(picsheadurl);
	    console.log(cid);
	    console.log(picskeyword);
	    

	    $.ajax({
	        url: '/students323/insertPics',
	        data:"{\"picsname\":\""+picsname+"\",\"picsheadurl\":\""+picsheadurl+"\",\"picskeyword\":\""+picskeyword+"\",\"cid\":\""+cid+"\"}",
			type:'post',//HTTP请求类型
			dataType:'json', 
...
upload.render({
  ...
  , done: function (res, index, upload) {
      ...
      if (res.status == "ok") {
      	...
      	console.log(res.url);
      	$("#v_picsheadurl").attr("value",res.url);
