...
<div class="x-body">
    <form class="layui-form" id="mynews"   accept-charset="UTF-8" >
        ...
        <div class="layui-form-item">
            <label for="v_newsheadurl" class="layui-form-label">
                <span class="f_sp">新闻首图</span>
            </label>

           <input type="text" id="v_newsheadurl" name="v_newsheadurl"
                       autocomplete="off" value="" class="layui-input">
            ...
            <div class="layui-input-block">
                ...
                <div class="layui-upload-list">
                 ...
                 <a id="uploadVideobtn" class="layui-btn">上传</a>  
 				 <a  class="layui-btn"  id="createnews" onclick="createnews(this)" href="javascript:(0);" >创建</a> 
...
function createnews(obj){
	 	var newstitle=$("#v_newsname").attr("value");
	    var newsheadurl=$("#v_newsheadurl").attr("value");
	    var newskeyword=$("#v_newskeyword").attr("value");
	    var cid = $("#fieldSelect").attr("value");
	    if(newstitle== ""){
	    	layer.msg('新闻标题不能为空',{icon:2,time:2000});
	    	return false;
	    }
	    if(newsheadurl== ""){
	    	layer.msg('新闻首图不能为空',{icon:2,time:2000});
	    	return false;
	    }
	    if(newskeyword== ""){
	    	layer.msg('新闻关键字不能为空',{icon:2,time:2000});
	    	return false;
	    }
	    console.log(newstitle);
	    console.log(newsheadurl);
	    console.log(cid);
	    console.log(newskeyword);
	    

	    $.ajax({
	        url: '/students323/insertNews',
	        data:"{\"newstitle\":\""+newstitle+"\",\"newsheadurl\":\""+newsheadurl+"\",\"newskeyword\":\""+newskeyword+"\",\"cid\":\""+cid+"\"}",
			type:'post',//HTTP请求类型
			dataType:'json', 
...
upload.render({
  ...
  , done: function (res, index, upload) {
      ...
      if (res.status == "ok") {
      	...
      	console.log(res.url);
      	$("#v_newsheadurl").attr("value",res.url);
